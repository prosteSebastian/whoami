    ...
    <section id="work" class="py-24 px-6 relative z-10 bg-[#fafaf9] border-t border-[#e7e5e4]">
      <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <!-- BJJ RPG PROJECT CARD (UPDATED WITH NUXTLINK) -->
          <NuxtLink to="/bjj" class="bg-white p-8 rounded-lg border border-[#e7e5e4] shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative group overflow-hidden cursor-pointer block">
            ...
            <div class="relative z-10">
              <div class="mb-6">
                <div class="flex justify-between items-start mb-2">
                  <h3 class="font-serif font-bold text-2xl text-[#431407]">BJJ RPG</h3>
                  <Star class="w-5 h-5 text-[#d97706]" fill="#d97706" />
                </div>
                <p class="text-xs font-bold uppercase tracking-widest text-[#a8a29e]">Interactive Web App</p>
              </div>
              <p class="text-[#5d4037] leading-relaxed text-sm md:text-base mb-6 min-h-[80px]">
              A gamified, tactical HUD for Brazilian Jiu-Jitsu. Explore positions, practice transitions, and study techniques in an RPG-style interface.
              </p>
              <div class="flex flex-wrap gap-2 pt-4 border-t border-[#f5f5f4]">
                <span v-for="tag in ['Vue 3', 'Tailwind', 'Nuxt']" :key="tag" class="tag">{{ tag }}</span>
              </div>
            </div>
          </NuxtLink>
